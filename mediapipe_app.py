...
with MediapipeRunner() as mp:
    ...
    while v_cap.isOpened():
        ...
        for jawline in metrics.get_jaw_indices():
            ...
            cv2.circle(image, center=(x, y), color=Colors.RED, radius=2, thickness=3)# color = BGR
        ...
        cv2.line(image, pt1=(cheek_left[0], cheek_left[1]), pt2=(cheek_right[0], cheek_right[1]), color=Colors.BLUE, thickness=2)
        ...
        cv2.rectangle(image, pt1=(frame_width-10, frame_height-10), 
                        pt2=(frame_width-int(cheek_width*0.5), frame_height-int(cheek_width*0.5)), 
                        color=Colors.BLUE, thickness=2)#blue,green,red
        ...
        cv2.line(image, pt1=(jaw_center[0], jaw_center[1]), pt2=(jaw_center[0], jaw_center[1]), 
            color=Colors.RED, thickness=2)#blue,green,red
        ...
        cv2.rectangle(image, pt1=(frame_width-10, frame_height-150), 
                        pt2=(frame_width-int(jaw_gap*1.0), frame_height-150-int(jaw_gap*1.0)), 
                        color=Colors.RED, thickness=2)#blue,green,red
        ...
        cv2.rectangle(image, pt1=(frame_width-10, frame_height-300), 
                        pt2=(frame_width-int(distance_gap*0.5), frame_height-300-int(distance_gap*0.5)), 
                        color=Colors.GREEN, thickness=2)#blue,green,red
